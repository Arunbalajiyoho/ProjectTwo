  ...
  <span className="px-4 mb-4">
    <Dropdown as={ButtonGroup}>
      ...
      <Dropdown.Menu>
        ...
        <DropdownItem>
        <b> Country/Region <input type="text" placeholder="india"/></b>
        </DropdownItem>
        <DropdownItem>
        <b > City <input type="text"  className="ms-5 ps-5" placeholder=""/></b>
        </DropdownItem>
        <DropdownItem>
        <button type="button" className="bg-primary rounded-pill px-3">Apply</button>
        <b>Clear</b>
        </DropdownItem>
...
<div>
    <div className="container ms-5 py-4">
    <h5>Creative For Hire</h5>
    </div>
</div>
    ...
    <div className="col">
      <Card style={{ width: "20rem" }}>
        <Card.Body>
          ...
          <Card.Text>
           <b> Industrial Designer for Innovative packaging. Looking for</b>
    ...
    <div className="col">
      <Card style={{ width: "20rem" }}>
        <Card.Body>
          ...
          <Card.Text>
            <b>Storytelling Video Editors &Creater Needed ! Job Opportunity For:</b>
  ...
  <div className="row">
    <div className="col">
      <Card style={{ width: "20rem" }}>
        <Card.Body>
          ...
          <Card.Text>
           <b>Visual Designer</b>
           <p>We're looking for a quality visual designer to help build out a corporate brand</p>
          </Card.Text>
      ...
      <Card style={{ width: "20rem" }}>
        <Card.Body>
          ...
          <Card.Text>
            ...
            <p>$700 per video (negotiable) - Commentary/Reactions Editor</p>
          </Card.Text>
          <Card.Footer>7 days ago</Card.Footer>
        </Card.Body>
      </Card>
    ...
    <div className="col">
      <Card style={{ width: "20rem" }}>
       ...
       <p>We are looking for a Brand Designer for a completed brand identity and logo design.</p>
          </Card.Text>
          <Card.Footer>7 days ago</Card.Footer>
        </Card.Body>
      </Card>
  ...
  <div className="row">
    ...
    <div className="col">
      <Card style={{ width: "20rem" }}>
       ...
       <p>We are looking for a graphic designer to create compelling visuals. Primarily to create  online marketing.</p>
          </Card.Text>
          <Card.Footer>7 days ago</Card.Footer>
        </Card.Body>
      </Card>
      ...
      <Card style={{ width: "20rem" }}>
        <Card.Body>
          ...
          <Card.Text>
            ...
            <p>We are looking for creative industrial packaging designer </p>
          </Card.Text>
    ...
    <div className="col">
      <Card style={{ width: "20rem" }}>
        <Card.Body>
          ...
          <Card.Text>
       <b> Web Designer </b>
       <p>AlanChikinChow is seeking a skilled Website Designer to  their  website!</p>
          </Card.Text>
      ...
      <Card style={{ width: "20rem" }}>
        <Card.Body>
          ...
          <Card.Text>
           ...
           <p className="fs-6">We are looking for an creative designer</p>
          </Card.Text>
